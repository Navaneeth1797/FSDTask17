...
export let userContext = React.createContext(); // Creating a context named userContext

function cartPageContextComponent({ children }) {
  // Initializing state for products using useState hook
  ...
  return (
    // Providing the products state and setProducts function to the userContext.Provider
